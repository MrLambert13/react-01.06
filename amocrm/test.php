...
$link = 'https://' . $subdomain . '.amocrm.ru/private/api/auth.php';
...
curl_setopt($curl, CURLOPT_COOKIEFILE, dirname(__FILE__) . '/cooki2e.txt'); #PHP>5.3.6 dirname(__FILE__) -> __DIR__
curl_setopt($curl, CURLOPT_COOKIEJAR, dirname(__FILE__) . '/cooki2e.txt'); #PHP>5.3.6 dirname(__FILE__) -> __DIR__
